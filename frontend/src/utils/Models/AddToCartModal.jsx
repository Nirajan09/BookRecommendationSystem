    ...
    >
      ...
      >
        ...
        <button
          onClick={onAddToCart}
          disabled={adding}
          className={`w-full py-3 mt-3 rounded-xl text-lg font-bold shadow-md transition ${
            adding
        ...
        <button
          onClick={onClose}
          className="w-full py-3 mt-2 rounded-xl text-lg font-semibold text-gray-700 bg-gray-200 hover:bg-gray-300 shadow-sm transition"
        >
          Cancel
        </button>
      </div>
