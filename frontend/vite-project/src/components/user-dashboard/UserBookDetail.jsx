      ...
      {showCartModal && (
        <div className="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center z-50">
          <div className="bg-white rounded-md p-6 max-w-sm w-full shadow-lg">
            ...
            <p>
              <b>Price per unit:</b> ${book.price.toFixed(2)}
            </p>
            <p className="mb-4">
            ...
            <div className="flex items-center mb-4 space-x-4">
              ...
              <button
                ...
                className={`px-3 py-1 rounded text-white ${quantity >= book.quantity
            ...
            <button
              ...
              disabled={addingCart}
              className={`w-full py-2 rounded text-white font-semibold ${addingCart ? "bg-gray-400" : "bg-indigo-600 hover:bg-indigo-700"
                }`}
            >
